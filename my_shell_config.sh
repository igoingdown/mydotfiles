...
alias ref="cd $HOME/github/referral/004-platforms/001-byr-bbs/003-bytedance && cat text.txt | pbcopy && goto bbs"
alias msref="cd $HOME/github/referral/004-platforms/001-byr-bbs/002-ms-stca && cat text.txt | pbcopy && goto bbs"
alias mapref="cd $HOME/github/referral/004-platforms/001-byr-bbs/004-amap && cat text.txt | pbcopy && goto bbs"
